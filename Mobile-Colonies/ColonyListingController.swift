...
class ColonyListingController:UITableViewController, UIPopoverPresentationControllerDelegate, UIGestureRecognizerDelegate{
    ...
    func saveTemplates(){
        print("Saving...");
        print(NSKeyedArchiver.archiveRootObject(usertemplates.allColonies, toFile: ColonyData.templateArchive.path));
        print("Done!");
    }
    
    func saveColonies(){
        print("Saving...");
        print(NSKeyedArchiver.archiveRootObject(colonies.allColonies, toFile: ColonyData.colonyArchive.path));
        print("Done!");
    }
    
    func loadTemplates()->[ColonyData]?{
        return NSKeyedUnarchiver.unarchiveObject(withFile: ColonyData.templateArchive.path) as? [ColonyData]
    }
    
    func loadColonies()->[ColonyData]?{
        return NSKeyedUnarchiver.unarchiveObject(withFile: ColonyData.colonyArchive.path) as? [ColonyData]
    }
    
    override func viewDidLoad() {
        
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Blinker",fromDiagram:
            """
            *
            *
            *
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Toad",fromDiagram:
            """
            --*-
            *  *
            *  *
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Beacon",fromDiagram:
            """
            **--
            *---
            ---*
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Pulsar",fromDiagram:
            """
            --***----***--
            --------------
            *----*--*----*
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Pentadecathlon",fromDiagram:
            """
            ***
            *-*
            ***
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Glider",fromDiagram:
            """
            -*-
            --*
            ***
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Lightweight Spaceship",fromDiagram:
            """
            *---*-
            -----*
            *----*
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Block Switching Engine",fromDiagram:
            """
            ***-*
            *----
            ---**
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Slow Spaceship",fromDiagram:
            """
            -****--------------
            -*---*---------*---
            -*-----------**----
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Static Spaceship",fromDiagram:
            """
            ---***---***---
            ---------------
            -**---*-*---**-
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Gosper Glider Gun",fromDiagram:
            """
            ------------------------*-----------
            ----------------------*-*-----------
            ------------**------**------------**
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Backrake",fromDiagram:
            """
            .....OOO...........OOO.....
            ....O...O.........O...O....
            ...OO....O.......O....OO...
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Cow",fromDiagram:
            """
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Dragon",fromDiagram:
            """
            .............O..OO......O..OOO
            .....O...OOOO.OOOOOO....O..OOO
            .OOOOO....O....O....OOO.......
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Electric Fence",fromDiagram:
            """
            ..........O..................................................
            .........O.O........................OO.......................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Enterprise",fromDiagram:
            """
            .......OOO...........
            .....O.OO............
            ....OOOO.............
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Filter",fromDiagram:
            """
            ..........................
            ................OO........
            ..............O....O......
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Fly",fromDiagram:
            """
            ..O...............................
            .O.O..............................
            .O.O......................O.O...O.
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Frothing Puffer",fromDiagram:
            """
            .......O.................O.......
            ......OOO...............OOO......
            .....OO....OOO.....OOO....OO.....
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Hammerheads",fromDiagram:
            """
            ................O..
            .OO...........O...O
            OO.OOO.......O.....
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Volcano",fromDiagram:
            """
            .........O..........................
            ........O.O.........................
            ......OOO.O.........................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Portraitor",fromDiagram:
            """
            ...........OO...........
            ......OO.O....O.OO......
            ......O..........O......
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Puff Suppresor",fromDiagram:
            """
            ............O....................
            ..........OO.O...................
            ..........OO...O.................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Ring Of Fire",fromDiagram:
            """
            ................O.................
            ..............O.O.O...............
            ............O.O.O.O.O.............
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Snail",fromDiagram:
            """
            .O....................................
            .O....................................
            O.....................................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Spaceship",fromDiagram:
            """
            .............OO.....................................
            .....OO....OO.O.O...................................
            ....OOO....OOOO.....................................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Wickstretcher",fromDiagram:
            """
            .................OO..............................
            .............OO....O.............................
            ............OOO.O................................
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name:"Tubstretcher",fromRLE:
            """
        ...
        addNewTemplate(withData: Colony.colonyDataInterpret(name: "Hawk", fromRLE:
        """
